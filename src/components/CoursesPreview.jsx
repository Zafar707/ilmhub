...
const coursesData = [
  { id: 1, title: "C++ Foundation", category: "foundation", price: "$75", image: "../../public/images/c++.png", level: "Beginner", description: "Learn the fundamentals of C++ programming.", duration: { uz: "2 oy", ru: "2 месяца", en: "2 months" }, syllabus: ["Basic Syntax", "Data Types", "Functions", "OOP Basics"], requirements: "No prior experience" },
  { id: 2, title: "Python Backend", category: "backend", price: "$120", image: "../../public/images/python.png", level: "Intermediate", description: "Build robust backend systems with Python and Django/Flask.", duration: { uz: "3 oy", ru: "3 месяца", en: "3 months" }, syllabus: ["Django REST Framework", "Databases (SQL/NoSQL)", "API Design"], requirements: "Python basics" },
  { id: 3, title: ".NET Backend", category: "backend", price: "$130", image: "../../public/images/netbackend.png", level: "Intermediate", description: "Develop scalable backend applications using .NET Core.", duration: { uz: "3.5 oy", ru: "3.5 месяца", en: "3.5 months" }, syllabus: ["ASP.NET Core", "Entity Framework", "Microservices"], requirements: "C# basics" },
  { id: 4, title: "FullStack Bootcamp", category: "bootcamps", price: "$200", image: "../../public/images/bootcamp.png", level: "Advanced", description: "Comprehensive bootcamp for aspiring FullStack developers.", duration: { uz: "6 oy", ru: "6 месяцев", en: "6 months" }, syllabus: ["Frontend (React/Vue)", "Backend (Node.js/Python)", "Databases", "Deployment"], requirements: "Basic programming" },
  { id: 5, title: "AI Fundamentals", category: "ai", price: "$250", image: "../../public/images/ai.png", level: "Advanced", description: "Master Artificial Intelligence and Machine Learning techniques.", duration: { uz: "4.5 oy", ru: "4.5 месяца", en: "4.5 months" }, syllabus: ["Python for AI", "Machine Learning Algorithms", "Deep Learning with TensorFlow"], requirements: "Python basics, Linear Algebra" },
  { id: 6, title: "Python Beginner (Kids)", category: "kids", price: "$40", image: "../../public/images/python.png", level: "Beginner", description: "Fun introduction to Python programming for kids.", duration: { uz: "1.5 oy", ru: "1.5 месяца", en: "1.5 months" }, syllabus: ["Basic Concepts", "Simple Games", "Problem Solving"], requirements: "Ages 8-12" },
  { id: 7, title: "App Inventor (Kids)", category: "kids", price: "$45", image: "../../public/images/app.png", level: "Beginner", description: "Create mobile apps without coding for young innovators.", duration: { uz: "2 oy", ru: "2 месяца", en: "2 months" }, syllabus: ["UI/UX Basics", "App Logic", "Testing"], requirements: "Ages 10-14" },
  { id: 8, title: "Scratch (Kids)", category: "kids", price: "$35", image: "../../public/images/scratch.png", level: "Beginner", description: "Visual programming for creative young minds.", duration: { uz: "1 oy", ru: "1 месяц", en: "1 month" }, syllabus: ["Animations", "Interactive Stories", "Game Design"], requirements: "Ages 6-10" },
  { id: 9, title: "Arduino Basics (Kids)", category: "kids", price: "$50", image: "../../public/images/arduino.png", level: "Beginner", description: "Introduction to electronics and coding with Arduino.", duration: { uz: "2.5 oy", ru: "2.5 месяца", en: "2.5 months" }, syllabus: ["Circuits", "Sensors", "Robotics Basics"], requirements: "Ages 12+" },
  { id: 10, title: "React Native Mobile", category: "mobile", price: "$150", image: "../../public/images/react.png", level: "Intermediate", description: "Build cross-platform mobile apps with React Native.", duration: { uz: "3.5 oy", ru: "3.5 месяца", en: "3.5 months" }, syllabus: ["React Fundamentals", "Native Components", "API Integration"], requirements: "JavaScript basics" },
  { id: 11, title: "Flutter Mobile", category: "mobile", price: "$160", image: "../../public/images/flutter.png", level: "Intermediate", description: "Develop beautiful native apps with Google's Flutter framework.", duration: { uz: "3.5 oy", ru: "3.5 месяца", en: "3.5 months" }, syllabus: ["Dart Programming", "Widgets", "State Management"], requirements: "Programming basics" },
  { id: 12, title: "Swift UI Mobile", category: "mobile", price: "$170", image: "../../public/images/swift.png", level: "Intermediate", description: "Create stunning iOS apps with Apple's declarative UI framework.", duration: { uz: "4 oy", ru: "4 месяца", en: "4 months" }, syllabus: ["Swift Language", "UI Design", "Data Persistence"], requirements: "Basic programming concepts" },
  { id: 13, title: "English Phonics (Level 1)", category: "english", price: "$50", image: "../../public/images/english.png", level: "Beginner", description: "Foundational phonics for early English learners.", duration: { uz: "1 oy", ru: "1 месяц", en: "1 month" }, syllabus: ["Alphabet Sounds", "Blends", "Simple Words"], requirements: "No prior experience" },
  { id: 14, title: "English Phonics (Level 2)", category: "english", price: "$55", image: "../../public/images/english2.png", level: "Beginner", description: "Building on phonics basics for improved reading.", duration: { uz: "1 oy", ru: "1 месяц", en: "1 month" }, syllabus: ["Long Vowels", "Digraphs", "Sight Words"], requirements: "Phonics Level 1" },
  { id: 15, title: "English Phonics (Level 3)", category: "english", price: "$60", image: "../../public/images/english3.png", level: "Intermediate", description: "Advanced phonics for fluency and comprehension.", duration: { uz: "1.5 oy", ru: "1.5 месяца", en: "1.5 months" }, syllabus: ["Complex Sounds", "Syllabication", "Reading Fluency"], requirements: "Phonics Level 2" },
];
